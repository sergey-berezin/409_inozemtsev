...
namespace WpfApp1
{
    ...
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        private string img1;
        private string img2;
        private Database.Image img_from_storage;
        ...
        public Database.Image ImageFromStorage
        {
    ...
    public partial class MainWindow : Window
    {
        ...
        private async Task<int> PostImage(string image_path)
        {
            ...
            {
                System.Windows.MessageBox.Show("Failed to connect to the server:\n" + PostLink, "Http Request Exception", MessageBoxButton.OK, MessageBoxImage.Error);
                return -1;
            }
        }
