...
namespace NuGet_ArcFace_Embedder
{
    public class Embedder
    {
        ...
        private Mutex CalculationsMutex;
        ...
        public Embedder()
        {
            SessionOptions parallel_options = new SessionOptions();
            parallel_options.ExecutionMode = ExecutionMode.ORT_PARALLEL;
            
            this.Session = new InferenceSession("arcfaceresnet100-8.onnx", parallel_options);
            this.CalculationsCollection = new Dictionary<string, Task<float[]>>();
            this.CalculationsMutex = new Mutex();
        }
        ...
        public string Embed(Image<Rgb24> img)
        {
            ...
            CalculationsMutex.WaitOne();
            CalculationsCollection[session_key] = new_task;
            CalculationsMutex.ReleaseMutex();
